...
st.write("多くの謎を秘めた宇宙と海に関する質問に答えるWebアプリです。")
...
if selected_item == "宇宙の謎":
    input_message = st.text_input(label="宇宙の謎についてあなたの疑問に答えます。テキストを入力してください。")
    text_count = len(input_message)
else:
    input_message = st.text_input(label="海の秘密についてあなたの疑問に答えます。テキストを入力してください。")
    text_count = len(input_message)
